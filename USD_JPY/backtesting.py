...
"""
################################## important #############################################
################## This model("model6.json") are only working on USD_JPY #################
############### if need to use other instruments have to train new model ##############
##########################################################################################
...
################################################################################################################
                ...
                if  dif < -0.125 and trade == [] : # open sell order if different value lower -0.125
                    print("sell")
                    trade.append(next_o)  # open order
                    cur = "sell"  # save status
                    side.append(True) 
                elif  dif > 0.125 and trade == [] : # open buy order if different value more than 0.125
                    print("buy")
                    trade.append(next_o) # open order
                    cur = "buy"  # save status
                    side.append(True)
